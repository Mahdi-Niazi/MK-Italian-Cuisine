...
<div align="center">
  ...
  <img src="./src/assets/mklogo.png" alt="logo" width="140"  height="auto" />
  <br/>
  <h1><b>MK Italian Cuisine</b></h1>
...
**MK Italian Cuisine** is a website that generates Italian foods where customer can reserve and comment the food. It also allows customer to like the food. All data is preserved thanks to the external Involvement API service.
...
```
  git clone https://github.com/Mahdi-Niazi/Group-Capstone.git
  cd Group-Capstone
```
### Install 
...
Feel free to check the [issues page](https://github.com/Kccendana/Leaderboard/issues).
